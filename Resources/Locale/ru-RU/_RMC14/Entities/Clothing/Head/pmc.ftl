...
ent-RMCArmorHelmetPMCDeathsquadAlt = PMC M5X helmet
...
ent-ArmorHelmetPMCCorporateLead = We-Ya corporate security helmet
...
ent-ArmorHelmetPMCRiotShield = RC6 helmet
  .desc = The standard UN Riot Control 6 helmet is of odd design, lacking a face shield by default (mounting points are available). The distinct white pattern and red emblem are synonymous with oppression throughout the rim.

ent-RMCArmorHelmetPMCCorporateHybrisa = We-Ya corporate security helmet
...
ent-RMCArmorHelmetPMCCorporateLeadHybrisa = We-Ya corporate security helmet
