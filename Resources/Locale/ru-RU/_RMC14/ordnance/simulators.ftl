...
ent-RMCExplosionSimulator = компьютер симуляции взрыва
    .desc = Мощный симуляционный компьютер для анализа взрывного действия химических смесей по разным типам целей. Вставьте стакан с реагентами, выберите тип цели и запустите двухминутную симуляцию.

ent-RMCDemolitionsCamera = симуляционная камера
    .desc = Одноразовая камера полигона, используемая симуляторами подрывного дела.

rmc-explosion-sim-slot-beaker = Слот стакана
...
rmc-explosion-sim-ui-no-beaker = Стакан с образцом не вставлен.
...
rmc-explosion-sim-ui-beaker-loaded = Химический образец загружен в аналитический отсек.
rmc-explosion-sim-ui-readiness-no-beaker-line1 = Вставьте стакан,
rmc-explosion-sim-ui-readiness-no-beaker-line2 = чтобы начать анализ.
...
rmc-explosion-sim-ui-status-idle-line1 = Загрузите стакан с образцом, выберите профиль цели
